      ...
      {done ? (
        <>
          ...
          <p className="mt-3 max-w-md text-muted-foreground">
            We've removed you from our marketing emails. You'll still receive critical account
            messages (password resets, billing).
          </p>
          <Link
            to="/"
        ...
        <>
          ...
          <p className="mt-3 max-w-md text-muted-foreground">
            You'll stop receiving the weekly digest and product updates. We won't email you again
            unless you ask.
          </p>
          <button
            onClick={() => {
