  ...
  head: () => ({
    meta: [
      { title: "Features — LanceConnect" },
      {
        name: "description",
        content:
          "Deep dive into every feature: lead discovery, opportunity scoring, CRM pipeline, outreach templates, and the AI message writer.",
      },
...
const sections = [
  {
    ...
    desc: "Search any city in 150+ countries and surface businesses matching the criteria that matter to your craft.",
    points: [
      "Filter by industry, country, city, rating, and review count",
      "Detect businesses with no website, broken sites, or empty social",
  ...
  },
  {
    ...
    desc: "Every lead gets a 0–100 score based on how badly they need what you sell. Hot leads bubble to the top.",
    points: [
      "Per-category scoring models — what's hot for an SEO is cold for a videographer",
      "Clear 'why' next to each score",
      "Filter for >80 to start your week with the best 20",
    ],
    image: IMG.seo,
  },
  {
    ...
    desc: "A simple kanban + table view that tracks every lead from saved → contacted → won, without a learning curve.",
    points: [
      "Drag-and-drop stages",
      "Per-lead notes, follow-up dates, and reminders",
  ...
  },
  {
    ...
    desc: "Email, phone scripts, WhatsApp messages, and LinkedIn DMs — all variable-templated to each lead.",
    points: [
      "Variables auto-fill business name, city, industry",
      "Channel filters (email / phone / DM)",
      "Save your own templates and reuse them in one click",
    ],
    image: IMG.copywriter,
  },
  {
    icon: Sparkles,
    title: "AI Outreach Writer (Pro)",
    desc: "Generate personalized first-touch messages in 5 languages, fed by each lead's profile.",
    points: [
      "Tone slider: friendly, formal, casual, direct",
      "One-click rewrite or shorten",
      "Multi-language: EN, ES, FR, IT, PT",
    ],
    image: IMG.appDev,
  },
  {
    icon: Phone,
    title: "Contact Details, One Click",
    desc: "Phone, email, website and socials — surfaced and copy-ready next to every lead.",
    points: [
      "Click-to-copy phone numbers",
      "Mailto + WhatsApp + LinkedIn buttons",
      "Notes field for that 'manager named Carla' detail",
    ],
    image: IMG.va,
  },
];
  ...
  return (
    <MarketingShell>
      <PageHeader
        ...
        subtitle="LanceConnect is built by freelancers — so it does only what helps you find and close clients. No CRM bloat. No sales-team jargon."
        ...
        <div className="grid gap-6 lg:grid-cols-3 auto-rows-[280px]">
          <div className="rounded-2xl border border-border bg-card p-8 shadow-card lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Find any business in any city in 150+ countries.
            </p>
            <ul className="space-y-2 text-sm">
              <li className="flex gap-2">
                <Zap className="h-4 w-4 text-primary shrink-0" />
                <span className="text-foreground/80">
                  Filter by industry, country, city, rating, reviews
                </span>
              </li>
              <li className="flex gap-2">
                <Zap className="h-4 w-4 text-primary shrink-0" />
                <span className="text-foreground/80">
                  Detect businesses with no website or empty social
                </span>
              </li>
              <li className="flex gap-2">
                <Zap className="h-4 w-4 text-primary shrink-0" />
                <span className="text-foreground/80">2.4M+ leads refreshed daily</span>
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              0–100 scores based on how badly they need you.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-card lg:row-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Phone, email, WhatsApp — all copy-ready.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Ready-made outreach for every channel.
            </p>
