      ...
      <section className="relative overflow-hidden border-b border-border bg-[#020b21] py-20 lg:py-28 text-center select-none text-white">
        ...
        <div className="relative mx-auto max-w-3xl px-4 lg:px-8 z-10">
          ...
          <h1 className="font-display text-4xl font-extrabold mt-3 sm:text-5xl tracking-tight leading-tight text-white">
            ...
            <br />
            and Clients with <span className="text-primary">Purpose.</span>
          </h1>
          <p className="mt-6 text-base text-slate-300 max-w-xl mx-auto leading-relaxed">
            We exist to bridge the gap between skilled professionals and the businesses that need
            them. Not just another marketplace—a true connector.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
              <p>
                We built <strong>LanceConnect</strong> because too many freelancers have the skills,
                the drive, and the potential—but not the client base to grow their careers. They are
                ready to work, ready to deliver value, yet they often lack a reliable way to connect
                with the clients who need their services.
              </p>
              <p>
                The world has shifted into a <strong>connector economy</strong>—where success is
                built on meaningful connections. But many platforms still connect freelancers to
                low-paying gigs or short-term opportunities that disappear as quickly as they
                appear. We believed there had to be a better way.
              </p>
              <p>
                That's why we created <strong>LanceConnect</strong>—a place where freelancers and
                clients can find each other with purpose. A place where talent meets real
                opportunity, and businesses connect with people who can help them grow. Not just
                another marketplace. A true connector.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="relative rounded-2xl border border-border bg-card p-6 shadow-card group hover:border-primary/30 transition duration-300">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                To make freelancing sustainable by giving every skilled professional direct access
                to clients who value their work.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl border border-border bg-card p-6 shadow-card group hover:border-[#10B981]/30 transition duration-300">
              <span className="text-[10px] font-mono text-secondary uppercase tracking-widest block mb-2">
                // mission
              </span>
              <h3 className="font-display text-lg font-bold mb-2">Human-Centered Connections</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                To connect freelancers and clients in a simple, trusted, and human way—turning
                skills into opportunities and opportunities into lasting relationships.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={v.title}
                className="rounded-2xl border border-border bg-card p-6 shadow-card group hover:border-primary/20 transition duration-300"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 lg:px-8 bg-background">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-start gap-3">
                  <span className="h-5 w-5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center text-xs shrink-0 mt-0.5 font-bold">
                    ✓
                  </span>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
              <p>
                We exist to <strong>bridge the gap</strong> between skilled freelancers and the
                clients looking for their expertise.
              </p>
              <p>
                Our goal is to make freelancing less about chasing leads and more about doing
                meaningful work. We want to give freelancers a direct path to opportunities and give
                clients confidence that the right person is only one connection away.
              </p>
              <p className="border-l-2 border-primary pl-4 py-1 text-muted-foreground italic font-medium bg-primary/5 rounded-r-lg">
                "At its core, LanceConnect is built on a simple belief: the right opportunity can
                change a career, and the right connection can change everything."
              </p>
              <p className="text-xs font-mono text-[#64748B] pt-2">
                // The foundation: freelancers don't lack talent — they lack access to clients and
                opportunities.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-xl px-4 text-white">
          ...
          <blockquote className="mt-4 font-display text-2xl font-bold italic leading-relaxed text-white">
            "A calm workspace designed for doing your best work, winning clients, and building a
      ...
      <section className="px-4 pb-20 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-3xl border border-border bg-card p-12 text-center relative overflow-hidden shadow-2xl">
          <h3 className="font-display text-2xl font-bold relative z-10">
            Want to help us build LanceConnect?
          </h3>
          <p className="mt-3 text-sm text-muted-foreground max-w-lg mx-auto relative z-10">
            We are always looking to partner with talented freelancers who care about this mission.
          </p>
          <Link
            to="/contact"
