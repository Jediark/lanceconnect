...
export const Route = createFileRoute("/about")({
  ...
  component: () => (
    <MarketingShell>
      {/* Premium Dark Hero */}
      <section className="relative overflow-hidden border-b border-border bg-[#080B14] py-20 lg:py-28 text-center select-none">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <img src={IMG.team} alt="" className="h-full w-full object-cover opacity-15 mix-blend-luminosity" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#080B14]/40 via-[#080B14]/75 to-[#080B14]" />
        </div>
        ...
        <div className="relative mx-auto max-w-3xl px-4 lg:px-8 z-10">
          ...
          <h1 className="font-display text-4xl font-extrabold text-white mt-3 sm:text-5xl tracking-tight leading-tight">
            Connecting Freelancers<br/>and Clients with <span className="bg-gradient-to-r from-primary to-[#818CF8] bg-clip-text text-transparent">Purpose.</span>
          </h1>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 lg:px-8 bg-[#080B14]">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            {/* Vision Card */}
            <div className="relative rounded-2xl border border-border bg-[#0F172A]/85 p-6 shadow-card group hover:border-primary/30 transition duration-300">
              <span className="text-[10px] font-mono text-primary uppercase tracking-widest block mb-2">// vision</span>
              <h3 className="font-display text-lg font-bold text-white mb-2">Sustainable Careers</h3>
            ...
            {/* Mission Card */}
            <div className="relative rounded-2xl border border-border bg-[#0F172A]/85 p-6 shadow-card group hover:border-[#10B981]/30 transition duration-300">
              <span className="text-[10px] font-mono text-secondary uppercase tracking-widest block mb-2">// mission</span>
              <h3 className="font-display text-lg font-bold text-white mb-2">Human-Centered Connections</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <section className="bg-[#0F172A]/30 py-20 border-y border-border">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-12">
            <p className="text-xs font-mono text-[#64748B] mb-2 tracking-widest uppercase">// core.values</p>
            <h2 className="font-display text-3xl font-extrabold text-white tracking-tight">What we believe</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={v.title} className="rounded-2xl border border-border bg-[#0F172A]/80 p-6 shadow-card group hover:border-primary/20 transition duration-300">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-5 text-sm text-slate-400 leading-relaxed">
              ...
              <p className="border-l-2 border-primary pl-4 py-1 text-slate-300 italic font-medium bg-primary/5 rounded-r-lg">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 lg:px-8 bg-[#080B14]">
        <div className="mx-auto max-w-2xl text-center mb-12">
          ...
          <h2 className="font-display text-3xl font-extrabold text-white tracking-tight">Meet the builders</h2>
          <p className="mt-3 text-sm text-slate-400">Six people across six time zones, building for freelancers everywhere.</p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {TEAM.map(m => (
            <div key={m.name} className="flex gap-4 rounded-2xl border border-border bg-[#0F172A]/80 p-5 shadow-card group hover:border-primary/20 transition duration-300">
              <img src={m.avatar} alt={m.name} className="h-14 w-14 shrink-0 rounded-full object-cover border-2 border-primary/20" />
              <div>
                <p className="font-display font-bold text-white text-base leading-snug">{m.name}</p>
                ...
                <p className="mt-3 text-xs text-slate-400 leading-relaxed">{m.bio}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="px-4 pb-20 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-3xl border border-border bg-gradient-to-r from-[#0F172A] to-[#080B14] p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <h3 className="font-display text-2xl font-bold text-white relative z-10">Want to help us build LanceConnect?</h3>
          <p className="mt-3 text-sm text-slate-400 max-w-lg mx-auto relative z-10">We are always looking to partner with talented freelancers who care about this mission.</p>
          <Link to="/contact" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-black hover:bg-white/95 transition shadow-lg relative z-10">
