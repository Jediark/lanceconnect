      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8 bg-background">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="relative rounded-3xl border border-primary/30 bg-gradient-to-br from-primary/5 via-card to-card p-8 md:p-12 shadow-[0_0_40px_rgba(6,182,212,0.1)] hover:shadow-[0_0_50px_rgba(6,182,212,0.15)] transition duration-300 overflow-hidden text-center">
            ...
            <div className="mt-6 flex justify-center items-baseline gap-1 text-white">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link
                to="/support-us"
                className="rounded-xl border border-rose-500/30 bg-rose-500/5 px-8 py-3 text-sm font-bold text-rose-400 hover:bg-rose-500/10 transition flex items-center justify-center gap-1.5"
              >
          ...
          {/* Philosophy Section */}
          <div className="grid gap-8 md:grid-cols-2 items-center bg-card/40 border border-border p-8 rounded-3xl backdrop-blur-sm">
            <div>
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-rose-500/10 text-rose-400 mb-4">
            ...
            <div className="border border-border bg-background/50 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex gap-3 text-xs text-slate-300">
                  ...
                  <span><strong>₦1,000</strong> covers basic API queries for 50 leads.</span>
                </div>
                <div className="flex gap-3 text-xs text-slate-300">
                  <span className="text-rose-500">❤️</span>
                  <span><strong>₦2,500</strong> funds database storage for 5,000 global leads.</span>
                </div>
                <div className="flex gap-3 text-xs text-slate-300">
                  <span className="text-rose-500">❤️</span>
                  <span><strong>₦5,000</strong> supports our server hosting fees for a month.</span>
                </div>
              </div>
              <div className="pt-2">
                <Link
                ...
                >
                  Visit Support Wall & Donate <ArrowRight className="h-3.5 w-3.5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              {faqs.map((f, i) => (
                <details key={i} className="group rounded-2xl border border-border bg-card p-4 transition-all duration-300">
                  <summary className="cursor-pointer list-none font-semibold flex items-center justify-between text-slate-200">
