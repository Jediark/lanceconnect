      ...
      <div className="mx-auto max-w-6xl px-4 py-16 space-y-16">
        ...
        <section className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-border bg-card p-6 space-y-4">
            ...
            <h3 className="font-display text-sm font-bold text-foreground">1. Export CSV</h3>
          ...
          <div className="rounded-3xl border border-border bg-card p-6 space-y-4">
            ...
            <h3 className="font-display text-sm font-bold text-foreground">2. Sync with CRM</h3>
            <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="rounded-3xl border border-border bg-card p-6 space-y-4">
            ...
            <h3 className="font-display text-sm font-bold text-foreground">3. Automate Outreach</h3>
            <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="font-display text-xl font-bold text-foreground flex items-center gap-2">
            <span className="h-6 w-6 rounded-full bg-cyan-400/10 text-cyan-550 dark:text-cyan-455 flex items-center justify-center text-xs font-bold font-mono">1</span>
            Exporting Leads from LanceConnect
          </h2>
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div className="space-y-4 text-xs sm:text-sm text-slate-700 dark:text-slate-350 leading-relaxed">
              <p>
                To export leads, navigate to the <a href="/app/discover" className="text-cyan-600 dark:text-cyan-400 hover:underline">Lead Discover</a> page. Type in a niche (e.g. "Italian Restaurant") and a target city (e.g. "Chicago").
              </p>
              <p>
            ...
            <div className="rounded-3xl border border-border bg-slate-50 dark:bg-[#0a1128]/40 p-6 space-y-4">
              <h3 className="font-display text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">CSV Column Structure</h3>
              <div className="max-h-64 overflow-y-auto space-y-2 pr-2">
                {csvColumns.map((col, idx) => (
                  <div key={idx} className="flex justify-between border-b border-border/60 pb-1.5 text-xs">
                    <div>
                      <span className="font-bold text-foreground font-mono">{col.name}</span>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">{col.description}</p>
                    </div>
                    <span className="font-mono text-[10px] text-cyan-600 dark:text-cyan-400 self-start">{col.type}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="space-y-6">
          <h2 className="font-display text-xl font-bold text-foreground flex items-center gap-2">
            <span className="h-6 w-6 rounded-full bg-cyan-400/10 text-cyan-550 dark:text-cyan-455 flex items-center justify-center text-xs font-bold font-mono">2</span>
            CRM Integration Walkthrough
          </h2>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-border bg-card p-6 space-y-4">
              <div className="flex items-center gap-2 text-orange-550 dark:text-orange-400 font-bold text-sm">
                <span className="rounded bg-orange-450/10 dark:bg-orange-400/10 px-2 py-0.5 text-[10px] font-mono uppercase">HubSpot</span>
                <h3>HubSpot Import Steps</h3>
              </div>
              <ul className="space-y-3.5 text-xs text-slate-700 dark:text-slate-350 list-decimal pl-6">
                ...
                <li>Map the CSV column headers:
                  <ul className="mt-1.5 space-y-1 text-[10px] text-slate-500 dark:text-slate-400 list-disc pl-4 font-mono">
            ...
            <div className="rounded-3xl border border-border bg-card p-6 space-y-4">
              <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400 font-bold text-sm">
                <span className="rounded bg-cyan-450/10 dark:bg-cyan-400/10 px-2 py-0.5 text-[10px] font-mono uppercase">Salesforce</span>
        ...
        <section className="space-y-6">
          <h2 className="font-display text-xl font-bold text-foreground flex items-center gap-2">
            <span className="h-6 w-6 rounded-full bg-cyan-400/10 text-cyan-550 dark:text-cyan-455 flex items-center justify-center text-xs font-bold font-mono">3</span>
          ...
          <div className="rounded-3xl border border-border bg-card p-8 md:p-12 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-3 pt-4 border-t border-border">
              <div className="space-y-2">
                <h4 className="font-bold text-foreground text-xs">Step A: Setup Senders</h4>
                <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-foreground text-xs">Step B: Upload Leads</h4>
                <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-foreground text-xs">Step C: Write Campaigns</h4>
                <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
