...
export const Route = createFileRoute("/portfolio")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore portfolios of top-tier global freelancers across web development, design, SEO, and copywriting." },
      { property: "og:title", content: "LanceConnect Portfolio Directory" },
      { property: "og:description", content: "See visual work showcases and hire professional freelancers directly." },
    ],
  }),
...
const PORTFOLIO_FREELANCERS = [
  {
    ...
    projects: [
      { title: "SaaS Dashboard Interface", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&q=80", desc: "A modern analytics app built with React & Tailwind." },
      { title: "Bespoke Hotel Portal", image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=80", desc: "Online booking engine and CMS for a boutique hotel." }
    ]
  },
  {
    name: "Maria Silva",
    ...
    projects: [
      { title: "Neobank Visual System", image: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&q=80", desc: "Full rebranding, mobile interfaces and guidelines." },
      { title: "Organic Cosmetics Pack", image: "https://images.unsplash.com/photo-1608248597481-496100c8c836?w=400&q=80", desc: "Eco-friendly retail box and bottle design." }
    ]
  },
  {
    name: "James Kariuki",
    ...
    projects: [
      { title: "Fintech Content Funnel", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&q=80", desc: "Scale traffic from 10k to 150k monthly visits." },
      { title: "SaaS Launch Ebook", image: "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?w=400&q=80", desc: "Complete copy strategy and PDF lead magnet." }
    ]
  },
  {
    name: "Priya Patel",
    ...
    projects: [
      { title: "Fitness App Launch Campaign", image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&q=80", desc: "Drove 12k app signups via Instagram Reels strategy." },
      { title: "B2B SaaS LinkedIn Growth", image: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=400&q=80", desc: "Organically grew CEO profile to 25k followers." }
    ]
  },
  {
    name: "Sofia Romano",
    ...
    projects: [
      { title: "Commercial Coffee Ad", image: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80", desc: "Social campaign commercial video." },
      { title: "Real Estate Cinematic Tour", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&q=80", desc: "Luxury video tour booked on YouTube." }
    ]
  },
  {
    ...
    projects: [
      { title: "Inbox & Ops Architecture", image: "https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=400&q=80", desc: "Automated standard workflows and scheduling." },
      { title: "Shopify Store Customer System", image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&q=80", desc: "Intercom integration and customer support scaling." }
    ]
  }
];
