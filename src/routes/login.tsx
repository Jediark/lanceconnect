      ...
      <div className="relative hidden overflow-hidden bg-sidebar p-12 text-sidebar-active lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative">
          <h2 className="font-display text-3xl font-bold leading-tight">
            Join 10,000+ freelancers finding clients daily.
          </h2>
          <ul className="mt-6 space-y-3 text-sm text-sidebar-foreground">
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-emerald-400" /> 10 free leads, no credit card
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-emerald-400" /> Works for any freelance skill
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-emerald-400" /> Businesses in 150+ countries
            </li>
          </ul>
        </div>
        <p className="relative text-xs text-sidebar-foreground/70">
          "Found 3 clients in my first week." — Taiwo A., Web Dev
        </p>
      </div>
  ...
  return (
    ...
    >
      <svg width="16" height="16" viewBox="0 0 48 48">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.91 11.91 0 0 1 24 36c-5.397 0-9.972-3.066-11.297-7.943l-6.522 5.025C9.527 39.556 16.227 44 24 44z"
        />
        <path
          fill="#1976D2"
