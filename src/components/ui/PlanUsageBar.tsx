  ...
  return (
    <div className="rounded-xl border border-sidebar-border/40 bg-sidebar-hover/60 p-3 text-sidebar-foreground">
      <div className="mb-1 flex items-center justify-between text-xs">
        <span className="font-medium uppercase tracking-wide text-sidebar-active/80">{plan} Plan</span>
        <span className="font-mono-data text-sidebar-active">{used}/{limit}</span>
      </div>
