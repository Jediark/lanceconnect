...
const SLIDES = [
  {
    img: IMG.heroFreelancer,
    kicker: "Lagos, Nigeria",
    title: "Taiwo found his first 3 web-dev clients in week one.",
    meta: "Web Developer · Free plan",
  },
  {
    img: IMG.marketStall,
    kicker: "Naples, Italy",
    title: "Sofia turned a local market into a portfolio of 8 brands.",
    meta: "Designer · Starter plan",
  },
  {
    img: IMG.coffeeShop,
    kicker: "Buenos Aires, Argentina",
    title: "Lucas books 2 discovery calls a day from coffee shops.",
    meta: "Copywriter · Pro plan",
  },
  {
    img: IMG.workspace,
    kicker: "Mumbai, India",
    title: "Priya replaced her 9-to-5 in 5 months of freelance SEO.",
    meta: "SEO Specialist · Pro plan",
  },
  {
    img: IMG.team,
    kicker: "Toronto, Canada",
    title: "Alex grew an agency of 4 — every lead from LanceConnect.",
    meta: "Agency owner · Agency plan",
  },
];
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              aria-label="Previous"
              className="grid h-10 w-10 place-items-center rounded-full border border-border bg-card hover:bg-accent"
            >
        ...
        <div ref={emblaRef} className="mt-10 overflow-hidden">
          <div className="flex -ml-5">
            {SLIDES.map((s) => (
              <div
                key={s.title}
                className="min-w-0 shrink-0 grow-0 basis-full pl-5 sm:basis-[80%] md:basis-[60%] lg:basis-[48%]"
              >
