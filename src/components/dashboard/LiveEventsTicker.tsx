...
const MOCK_EVENTS = [
  {
    id: 1,
    text: "Apex Digital in London just opened your email",
    icon: Mail,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  },
  {
    id: 2,
    text: "Cafe Nero in Rome replied to your proposal",
    icon: CheckCircle2,
  ...
  {
    id: 3,
    text: "You reached your daily goal of 50 new leads!",
    icon: Star,
  ...
  {
    id: 4,
    text: "AI generated a perfect pitch for Studio Q",
    icon: Sparkles,
  ...
  {
    id: 5,
    text: "John in New York clicked your portfolio link",
    icon: Mail,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  },
