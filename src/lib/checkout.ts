...
export async function initiateCheckout(params: CheckoutParams): Promise<CheckoutResult> {
  ...
  try {
    toast.loading(`Redirecting to ${isNgn ? "Paystack" : "Stripe"}...`, { id: "checkout-redirect" });
    ...
    if (isNgn) {
      ...
      const priceIdMap: Record<string, string> = {
        individual: import.meta.env.VITE_STRIPE_INDIVIDUAL_PRICE_ID || "price_individual_placeholder",
