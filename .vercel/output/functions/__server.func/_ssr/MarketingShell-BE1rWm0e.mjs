...
import { a as usePreferences, f as LanceConnectLogo, L as Logo } from "./router-B_AH9BqZ.mjs";
import { D as ArrowUp, m as MessageSquare, F as Send, e as Search, X, I as Menu } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full shrink-0 sticky top-0 z-50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border bg-[#080B14] w-full py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanceConnectLogo, { size: 32, showSlogan: false }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-4 lg:gap-6 text-xs lg:text-sm text-slate-400 md:flex", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:text-white transition-colors animate-fade-in", activeProps: { className: "text-white font-semibold" }, children: l.label }, l.to)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-2 lg:gap-3 md:flex", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden lg:inline", children: "Search..." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "hidden lg:inline bg-slate-950 border border-slate-800 rounded px-1.5 text-[9px]", children: "⌘K" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "rounded-lg px-2 py-1.5 lg:px-3 text-xs lg:text-sm font-medium text-slate-300 hover:bg-accent hover:text-white transition-colors", children: t("nav_login") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "rounded-lg bg-primary px-2.5 py-1.5 lg:px-3.5 text-xs lg:text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors whitespace-nowrap", children: t("nav_start_free") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(!open), className: "md:hidden rounded-lg p-2 text-slate-300 hover:bg-accent", "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) })
      ] }),
      open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-[#080B14] md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-4 py-3 gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-bold", children: "LanceConnect" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "The Meeting Point for Freelancers and Clients" })
          ] })
        ] }),
