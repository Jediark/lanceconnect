...
import { M as MarketingShell } from "./MarketingShell-BE1rWm0e.mjs";
import { u as useEmblaCarousel } from "../_libs/embla-carousel-react.mjs";
import { a as usePreferences, I as IMG, C as CATEGORIES, B as BLOG_POSTS } from "./router-B_AH9BqZ.mjs";
import "../_libs/sonner.mjs";
import { A as ArrowRight, r as Play, C as CircleCheck, s as ChevronLeft, t as ChevronRight, g as MapPin, u as Building2, f as Star, T as Target, v as Map, w as ChartLine, a as Mail, i as Earth, j as ChartColumn, P as Phone, k as Sparkles, B as Bookmark, G as Globe, U as Users, L as LoaderCircle, Z as Zap, e as Search, c as Check, x as Copy, d as Minus, y as Plus } from "../_libs/lucide-react.mjs";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2.5", children: [{
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: item.emoji }),
...
function WhoFor() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 py-24 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-5", children: CATEGORIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/freelancers/$slug", params: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-display text-sm font-semibold", children: c.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs leading-relaxed text-muted-foreground", children: c.example }),
