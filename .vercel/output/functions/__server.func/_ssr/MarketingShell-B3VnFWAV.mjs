...
import { a as usePreferences, f as LanceConnectLogo, L as Logo } from "./router-CgzKh1nW.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full shrink-0 sticky top-0 z-50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border bg-[#080B14] w-full py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LanceConnectLogo, { size: 32 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-7 text-sm text-slate-400 md:flex", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:text-white transition-colors", activeProps: { className: "text-white font-semibold" }, children: l.label }, l.to)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-3 md:flex", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "bg-slate-950 border border-slate-800 rounded px-1 text-[9px]", children: "⌘K" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "rounded-lg bg-primary px-3 py-1.5 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors whitespace-nowrap", children: t("nav_start_free") })
        ] }),
