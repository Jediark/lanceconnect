...
function HowPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MarketingShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 py-16 lg:px-8 space-y-20", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-10 items-center lg:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] w-full overflow-hidden rounded-3xl border border-border bg-[#0F172A] shadow-2xl group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s.image, alt: s.title, className: "h-full w-full object-cover transition duration-500 group-hover:scale-105", loading: "lazy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 right-4 flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-950/80 p-3 backdrop-blur shadow-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s.human, alt: s.caption, className: "h-9 w-9 rounded-full object-cover border-2 border-primary/45 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-white truncate leading-tight", children: s.caption }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-slate-400 font-mono mt-0.5 leading-none", children: "Verified Freelancer" })
          ] })
        ] })
      ] })
    ] }, s.n)) }),
