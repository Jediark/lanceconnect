...
import { a as usePreferences, f as LanceConnectLogo, L as Logo } from "./router-l5HUkJG7.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border bg-[#080B14] w-full py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-5 text-sm text-slate-400", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:text-white transition-colors animate-fade-in", activeProps: { className: "text-white font-semibold" }, children: l.label }, l.to)) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "bg-slate-950 border border-slate-800 rounded px-1.5 text-[9px]", children: "⌘K" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
