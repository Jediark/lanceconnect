...
import { a as usePreferences } from "./router-CpuVc37M.mjs";
import { Y as ArrowUp, m as MessageSquare, _ as Send, e as Search, G as Globe, $ as X, a0 as Menu } from "../_libs/lucide-react.mjs";
function MarketingNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full shrink-0 sticky top-0 z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-[#0F172A] py-1.5 px-4 lg:px-8 border-b border-border/40 select-none flex items-center justify-center lg:justify-between gap-3 text-xs font-mono text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px]", children: "Search (⌘K)" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-px bg-slate-800" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", ref: settingsRef, children: [
          ...
          settingsOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 mt-2 w-52 rounded-xl border border-border bg-[#0F172A] p-4 shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-150 font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border bg-[#080B14] w-full py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-5 text-sm text-white", children: desktopLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:text-white/80 transition-colors animate-fade-in", activeProps: { className: "text-white font-semibold border-b border-primary/60 pb-0.5" }, children: l.label }, l.to)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-px bg-border/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "rounded-lg px-3 py-1.5 text-sm font-medium text-white hover:text-white/80 transition-colors", children: t("nav_login") }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-paper", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-14 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center mb-4 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: "/logo-white.png",
            alt: "LanceConnect",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[300px] overflow-y-auto p-2", children: searchQuery ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                [
                  ...
                  Link,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-2", children: item.label }),
