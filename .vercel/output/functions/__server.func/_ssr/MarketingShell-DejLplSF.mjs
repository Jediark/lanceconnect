...
import { a as usePreferences } from "./router-BmphvtAh.mjs";
...
function MarketingNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full shrink-0 sticky top-0 z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-[#0F172A] py-1.5 px-4 lg:px-8 border-b border-border/40 select-none flex items-center justify-center lg:justify-between gap-3 text-xs font-mono text-[#CBD5E1]", children: [
