...
import { u as useAuth, L as Logo, c as cn } from "./router-CgzKh1nW.mjs";
import { P as PlanUsageBar } from "./PlanUsageBar-CGyoEZuD.mjs";
import { I as Menu, X, H as House, e as Search, K as Kanban, a as Mail, k as Sparkles, n as Settings, J as Crown } from "../_libs/lucide-react.mjs";
const NAV = [
  { section: "Main", items: [
