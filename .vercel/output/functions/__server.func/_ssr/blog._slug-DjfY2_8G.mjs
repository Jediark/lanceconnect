...
import { e as Route$c, B as BLOG_POSTS } from "./router-CpuVc37M.mjs";
import "../_libs/sonner.mjs";
import { a2 as ArrowLeft, a3 as Twitter, a4 as Linkedin, a5 as Link2 } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-3", children: related.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.cover, alt: "", className: "aspect-[16/10] w-full object-cover transition duration-300 group-hover:scale-105" }) }),
