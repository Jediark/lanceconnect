...
export async function sendEmail(params: EmailParams): Promise<boolean> {
  ...
  try {
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'LanceConnect <hello@lanceconnect.io>',
        to: [params.to],
...
export function getQuotaWarningEmailHtml(fullName: string, used: number, limit: number): string {
  return `
    <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
      ...
      <a href="https://lanceconnect.io/app/upgrade" style="display: inline-block; background-color: #0f172a; color: #ffffff; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin-top: 15px;">Upgrade Plan</a>
      <p style="color: #475569; margin-top: 24px;">Best regards,<br/>The LanceConnect Team</p>
    </div>
  `;
}
...
export function getPaymentFailedEmailHtml(fullName: string): string {
  return `
    <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
      ...
      <a href="https://lanceconnect.io/app/upgrade" style="display: inline-block; background-color: #be123c; color: #ffffff; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin-top: 15px;">Update Payment Method</a>
      <p style="color: #475569; margin-top: 24px;">Best regards,<br/>The LanceConnect Team</p>
    </div>
  `;
}
